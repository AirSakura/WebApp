  ...
  <div class="app-container">
        ...
        >
          <div class="security-table-bar">
            <div class="title">
              ...
              >
                <el-radio-button label="0">训练结果</el-radio-button>
                <el-radio-button label="1">测试结果</el-radio-button>
              </el-radio-group>
    ...
    >
      ...
      >
        ...
        <el-form-item label="集成学习算法" prop="model_name">
          <el-select
            ...
            @change="getParamsman"
          >
            <el-option label="RF模型" value="RF"></el-option>
          </el-select>
        </el-form-item>
        ...
        >
          <i
            v-if="
              item.name == ['n_estimators'] ||
                item.name == ['max_depth'] ||
                item.name == ['min_samples_split']
            "
          >
            <el-input
              class="input-unit"
          ...
          <i v-if="item.name == ['bootstrap'] || item.name == ['oob_score']">
            <el-select
              class="input-unit"
              v-model.trim="dataFormman[item.name]"
              :placeholder="'请选择' + item.name_c"
            >
              <el-option label="True" :value="1"></el-option>
              <el-option label="Fasle" :value="2"></el-option>
            </el-select>
          </i>
          <i v-if="item.name == ['max_features']">
            <el-select
              class="input-unit"
              v-model.trim="dataFormman[item.name]"
              :placeholder="'请选择' + item.name_c"
            >
              <el-option label="sqrt" :value="1"></el-option>
              <el-option label="log2" :value="2"></el-option>
              <el-option label="None" :value="3"></el-option>
            </el-select>
          </i>
        </el-form-item>
        <!--         
        <el-form-item label="弱学习器的最大迭代次数" prop="n_estimators">
          <el-input
            class="input-unit"
            v-model.trim="dataFormman.paras.n_estimators"
            placeholder="请输入"
          />
        </el-form-item>
        <el-form-item label="决策树最大深度" prop="max_depth">
          <el-input
            class="input-unit"
            v-model.trim="dataFormman.paras.max_depth"
            placeholder="请输入"
          />
        </el-form-item>
        <el-form-item label="内部结点再划分最小样本数" prop="min_samples_split">
          <el-input
            class="input-unit"
            v-model.trim="dataFormman.paras.min_samples_split"
            placeholder="请输入"
          />
        </el-form-item>
        <el-form-item label="是否放回" prop="bootstrap">
          <el-select
            :disabled="dataFormman.id > 0"
            class="input-unit"
            v-model="dataFormman.paras.bootstrap"
            placeholder="请选择"
          >
        ...
        <el-form-item label="是否使用袋外样本评估" prop="oob_score">
          <el-select
            :disabled="dataFormman.id > 0"
            class="input-unit"
            v-model="dataFormman.paras.oob_score"
            placeholder="请选择"
          >
            <el-option label="是" :value="1"></el-option>
            <el-option label="否" :value="2"></el-option>
        ...
        <el-form-item label="划分时考虑的最大特征数" prop="max_features">
          <el-select
            :disabled="dataFormman.id > 0"
            class="input-unit"
            v-model="dataFormman.paras.max_features"
            placeholder="请选择"
          >
            <el-option label="sqrt" :value="1"></el-option>
            <el-option label="log2" :value="2"></el-option>
    ...
    >
      ...
      >
        ...
        <el-form-item label="集成学习模型" prop="model_name">
          <el-select
            :disabled="dataFormman.id > 0"
            class="input-unit"
            v-model="dataFormman.model_name"
    ...
    >
      <div style="display: flex;">
        ...
        >
          ...
          <el-table-column align="center" label="排序" prop="region_name">
            <template slot-scope="{ row, $index }">
              {{ $index + 1 }}
            </template>
          </el-table-column>
          <el-table-column align="center" label="模型代码" prop="id" />
          <el-table-column align="center" label="基模型名称" prop="name" />
          <el-table-column align="center" label="水文模型" prop="model_name" />
        </el-table>
      </div>
