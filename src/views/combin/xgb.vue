      ...
      >
        ...
        <el-form-item label="集成学习算法" prop="model_name">
          <el-select
            ...
            @change="getParamsman"
          >
            <el-option label="XGB模型" value="XGB"></el-option>
          </el-select>
        </el-form-item>
    ...
    >
      <div style="display: flex;">
        ...
        >
          ...
          <el-table-column align="center" label="序号1" prop="region_name">
...
import { planList, calibmanList, calibrateChart,calibrateEvaluate } from "@/api/combin/xgb";
