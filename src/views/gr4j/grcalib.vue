      ...
      >
          ...
          <p class="filter-line">
            ...
            <span>
              <el-select
                ...
                v-model="listQuery.device_class"
                placeholder="选择设备型号"
                size="small"
              >
                <el-option
                  v-for="(d, index) in modelList"
                  :key="index"
                  :label="d.model_name"
                  :value="d.model_name"
                >
        ...
        "
          ...
          >
            ...
            <el-table-column fixed align="center" label="蒸发(mm)" prop="etp" />
            <el-table-column
              fixed
              align="center"
              label="实测流量(m³/s)"
...
import { gr4jDaily, gr4jDataExport, gr4jCalib } from "@/api/hydromodel/gr4j";
...
export default {
  ...
  data() {
    return {
      ...
      fileList: [],
      srcList: [],
      modelList: [{ model_name: "NSGAII" }, { model_name: "SCE_UA" }],
      listQuery: {
        page: 1,
        limit: 10,
        keywords: null,
