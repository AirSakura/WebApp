...
export function calibrateList(query) {
  return request({
    url: "/combin/xgb/calibrate_list?token=" + getToken(),
    method: "get",
    params: query
  });
}
...
export function calibmanList(query) {
  return request({
    url: "/combin/xgb/calibman_list?token=" + getToken(),
    method: "get",
    params: query
  });
}
...
export function planList(query) {
  return request({
    url: "/combin/xgb/list?token=" + getToken(),
    method: "get",
    params: query
  });
}
...
export function planAdd(data) {
  return request({
    url: "/combin/xgb/add?token=" + getToken(),
    method: "post",
    data
  });
}
...
export function planEdit(data) {
  return request({
    url: "/combin/xgb/edit?token=" + getToken(),
    method: "post",
    data
  });
}
...
export function editStatus(query) {
  return request({
    url: "/combin/xgb/edit_status?token=" + getToken(),
    method: "get",
    params: query
  });
}
...
export function deviceList(query) {
  return request({
    url: "/combin/xgb/station_list?token=" + getToken(),
    method: "get",
    params: query
  });
}
...
export function monitorData(query) {
  return request({
    url: "/combin/xgb/monitor_data_by_code?token=" + getToken(),
    method: "get",
    params: query
  });
}
...
export function getBasin(query) {
  return request({
    url: "/combin/xgb/get_basin?token=" + getToken(),
    method: "get",
    params: query
  });
}
...
export function getChildBasin(query) {
  return request({
    url: "/combin/xgb/get_childbasin?token=" + getToken(),
    method: "get",
    params: query
  });
}
...
export function calibrate(data) {
  return request({
    url: "/combin/xgb/calibrate?token=" + getToken(),
    method: "post",
    header: {
...
export function calibrateEvaluate(query) {
  return request({
    url: "/combin/xgb/calibrate_result_evaluate?token=" + getToken(),
    method: "get",
    params: query
  });
}
...
export function calibrateChart(query) {
  return request({
    url: "/combin/xgb/calibrate_result?token=" + getToken(),
    method: "get",
    params: query
  });
}
